...
import com.facens.conectbus.activity.PassageiroActivity;
import com.facens.conectbus.activity.RequisicoesActivity;
...
public class UsuarioFirebase {
        ...
        geoFire.setLocation(
                ...
                new GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        if(error!=null){
                            Log.d("Erro", "Erro ao salvar a localizacao!");
                        }
                    }
                }
        );
    ...
    public static String gerIdentificadorUsuario(){
